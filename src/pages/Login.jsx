  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-blueTop/80 via-blue-50/60 to-white overflow-hidden text-gray-900">
      ...
      <main className="relative z-10 flex justify-center px-4 pb-24">
        <section className="w-full max-w-xl bg-white/90 backdrop-blur-xl rounded-[30px] shadow-2xl ring-1 ring-white/60 px-8 py-10 mt-6 space-y-6">
          <div className="flex flex-col items-center gap-4">
            <img src="/assets/SescSenac.png" alt="Sesc Senac" className="h-16 object-contain" />
            <span className="px-6 py-1 rounded-full bg-blueTop text-white text-xs font-semibold tracking-[0.3em] uppercase border border-white/40 shadow shadow-blueTop/30">Login</span>
          </div>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              onClick={async()=>{
                try{
                  ...
                  navigate('/options')
                }catch(e){ setErro(e.message || 'Falha ao entrar') }
            ...
            <div className="text-center text-sm text-gray-600">
              <a href="#/forgot-password" className="text-blue-700 underline">esqueci a senha</a>
              <div className="mt-1">
                <a href="#/cadastro" className="text-blue-700 underline">não tem conta?</a>
              </div>
            </div>
          </div>
        </section>
